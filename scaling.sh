...
asg1=`aws autoscaling describe-launch-configurations --region us-east-1|grep LaunchConfigurationName|awk '{print $2}'|cut -c 2-
...
sleep 180
aws autoscaling update-auto-scaling-group --auto-scaling-group-name machine-factory-v1 --launch-configuration-name $lcfg2  --min-size 

1 --max-size 1 --vpc-zone-identifier $sub1
aws autoscaling update-auto-scaling-group --auto-scaling-group-name machine-factory-v1 --launch-configuration-name $lcfg2  --min-size 

1 --max-size 1 --vpc-zone-identifier $sub2
aws autoscaling delete-launch-configuration --launch-configuration-name $lcfg1
 ...
 sleep 180
aws autoscaling update-auto-scaling-group --auto-scaling-group-name machine-factory-v1 --launch-configuration-name $lcfg1  --min-size 
